...
"Class Skill 1":{
	...
	"Rank":"D",
	"Cooldown":5,
	"Description":"Madness Enhancement: D - Doubles Strength for three turns, but removes all buffs and prohibits the use of skills during Madness Enhancement (Cooldown - 5).",
	"Effect":[
	{"Buffs":[
