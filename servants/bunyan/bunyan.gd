...
"First Skill":{
	...
	"Rank":"A",
	"Cooldown":6,
	"Description ID":"Счастливые Товарищи: А - Увеличивает силу на 3 очка себе и союзникам на три хода. (Куллдаун - 6)",
	"Effect":[
	{"Buffs":
		{"Name":"ATK Up",
		"Duration":3,
...
"Second Skill":{
	...
	"Description":
		{
			"ru":"Озеро Фасолевого Супа: А - Восполняет здоровье всей команде на 8 очков. (Куллдаун - 6)",
			"en":""
		},
	"Description Id":"",
	"Effect":[
